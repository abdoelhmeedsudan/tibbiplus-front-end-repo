...
import { Specialization } from '../../../shared/services/specializations.service';
...
export class EditSpecializationModalComponent implements OnInit {
  ...
  populateForm(): void {
    if (this.specialization) {
      this.specializationForm.patchValue({
        nameAr: this.specialization.nameAr,
        nameEn: this.specialization.nameEn,
        jobTitleId: this.specialization.jobTitleId
      });
    }
  }
  ...
  onSubmit(): void {
    if (this.specializationForm.valid) {
      ...
      console.log('Updating specialization data:', formData);
