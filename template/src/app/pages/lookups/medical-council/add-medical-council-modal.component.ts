...
@Component({
  selector: 'app-add-medical-council-modal',
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule, TranslateModule],
  template: `
    <div class="modal-header">
      <h4 class="modal-title">{{ 'Add New Medical Council' | translate }}</h4>
...
export class AddMedicalCouncilModalComponent implements OnInit {
  ...
  save(): void {
    if (this.medicalCouncilForm.valid) {
      ...
      this.activeModal.close(this.medicalCouncilForm.value);
    } else {
